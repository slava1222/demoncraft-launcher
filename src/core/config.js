...
const OWNER = "slava1222";           // usuario de GitHub del dueño (se rellena cuando cree los repositorios)
...
module.exports = {
    ...
    // donde el launcher oficial guarda versiones, librerias, runtimes y perfiles
    minecraftDir: process.env.DEMONCRAFT_MINECRAFT_DIR || path.join(appData, ".minecraft"),
    profileId: "demoncraft",
    profileName: "DemonCraft",
    // id de la version propia que hereda de Forge y añade la entrada directa al servidor
